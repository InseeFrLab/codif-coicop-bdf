...
Le pipeline n'a qu'un mode : il code le fichier désigné par `input_file`. Si ce fichier porte
une colonne d'étiquettes, la désigner par `label-column` rend le run mesurable par l'[étape
`evaluate`](11-evaluate.qmd) — voir [Généralités](00-generalites.qmd).
