...
Tous ces codes sont **tronqués au niveau 4 et élagués** par `decide-coicop` quand
`--mapping-file` est fourni ([Prune](pruning.qmd)). La vérité terrain, elle, est dupliquée :
...
| `code_lvl4` | `decide-coicop` | Vérité terrain **canonique** : `code` tronqué au niveau 4 puis élagué. C'est la colonne que le [rapport](08-report.qmd) score. |
