...
| **MLflow** | Suivi des runs : expériences `test` (classify-rag-notices), `rag-annotation` (classify-rag-annotations) et `codif-coicop-eval` (report, avec `report.html` en artefact) ; héberge aussi le modèle TTC (`ttc-model-uri`). |
