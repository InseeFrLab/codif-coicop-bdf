...
# Format et plugins repris de l'ancien _quarto.yml du dépôt prez-coicop-groupe-veille,
# repliés ici pour un rendu au sein du projet Quarto docs/.
lang: en
from: markdown+emoji
fig-cap-location: bottom
format:
  insee-clair-revealjs: default
execute:
  echo: false
  cache: false
  message: false
