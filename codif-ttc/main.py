"""CLI entry point for codif-ttc — the neural COICOP text classifier (TTC).

The LLM-as-judge final decision (``decide-coicop``) lives in its own sibling
module ``decide-coicop/``.
"""
