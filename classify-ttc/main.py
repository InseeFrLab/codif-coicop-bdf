"""CLI entry point for classify-ttc — the neural COICOP text classifier (TTC).

The LLM-as-judge final decision (``reconcile-llm``) lives in its own sibling
module ``reconcile-llm/``.
"""
